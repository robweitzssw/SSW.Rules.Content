...
<youtubeEmbed url="https://www.youtube.com/watch?v=ZlAscAQnn8s" description={"Video: Profile README - GitHub Quick Tips - Gordon Beeming (1 min)"} />
...
* **(Optional) A stats widget**: See "Add the SSW stats widget" below
...
## Add the SSW stats widget

Lots of profiles use third-party stats services. SSW hosts its own, so use that instead. It renders a contribution summary card and keeps the data on SSW infrastructure.

Add this to your profile README, replacing `{{USERNAME}}` with your GitHub username:

```markdown
[![{{USERNAME}}'s GitHub stats](https://gitstats.ssw.com.au/api?username={{USERNAME}}&theme=dark)](https://github.com/SSWConsulting/SSW.GitHub.Profile.Stats)
```

The widget is maintained at [SSWConsulting/SSW.GitHub.Profile.Stats](https://github.com/SSWConsulting/SSW.GitHub.Profile.Stats).
